...
const Basket = ({ping, setping}) => {
  ...
  return (
    <div className='parentbasket'>
        ...
        <h1 className="titlebasket">Shopping with Pet Care</h1>
    ...
    <div className="basketcart">
      <div className="titlebag">Shopping Bag</div>
      {commandes?.filter((el)=>el?.nameuser===nameuser).map((el)=>
      <div className="item" key={el?._id}>
        
        <div className="imagebasket" >
          <img src={el?.imgproduct} alt="" className='impro'/>
        </div>
        <div className="descriptionbasket">
          ...
          <h5 className="status-badge-container">
           {el?.status === "Confirmed" && (
            <svg className="status-icon icon-confirmed" viewBox="0 0 24 24" width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM10 17L5 12L6.41 10.59L10 14.17L17.59 6.58L19 8L10 17Z" fill="#2ec4b6"/></svg>
           )}
           {el?.status === "Not Confirmed" && (
            <svg className="status-icon icon-not-confirmed" viewBox="0 0 24 24" width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM13 17H11V15H13V17ZM13 13H11V7H13V13Z" fill="#e63946"/></svg>
           )}
           <span>{el?.status}</span>
          </h5>
        ...
        <div className="buttonsbasket">
            ...
            <button className="deletebasket" onClick={()=>{dispatch(deletecommande(el?._id)); setping(!ping)}}>
